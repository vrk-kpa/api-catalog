...
class ApplyPermission(Base):
    ...
    @classmethod
    def create(cls, organization_id, business_code, contact_name, contact_email, ip_address_list, subsystem_code,
               subsystem_id, service_code, usage_description, request_date):

        apply_permission = ApplyPermission(organization_id=organization_id, business_code=business_code,
    ...
    def as_dict(self):
        ...
        application_dict['organization'] = toolkit.get_action('organization_show')({'ignore_auth': True}, {'id': application_dict['organization_id']})
        application_dict['service'] = toolkit.get_action('resource_show')({'ignore_auth': True}, {'id': application_dict['service_code']})
