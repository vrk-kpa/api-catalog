$(window).on("load", function() {
    ...
    if (element.value.length > 0 && element.value.split(',').length > 0) {
      element.value.split(',')
        .forEach(function(tag) {
          ...
          var container = $(element).siblings(".api-catalog-select2-tags-container");

          if (!container || container.length === 0) {
            $(element).after('<div class="api-catalog-select2-tags-container"></div>');
            container = $(element).siblings(".api-catalog-select2-tags-container");
          }
  ...
  $('select[data-module="autocomplete"].api-catalog-badges').each(function(index, element) {
  ...
  $('input[data-module="autocomplete"]')
    .on("change", function(e) {
      if (e.added) {
        ...
        var container = $(this).siblings(".api-catalog-select2-tags-container");

        if (!container || container.length === 0) {
          $(this).after('<div class="api-catalog-select2-tags-container"></div>');
          container = $(this).siblings(".api-catalog-select2-tags-container");
        }
    ...
    $('select[data-module="autocomplete"].api-catalog-badges')
    .on("change", function(e) {
      if (e.added) {
        var tag = e.added;
        tag.container = this.id;
...
var createTag = function(tag, container) {
  ...
  container.find("span:last-child").on("click", function(e) {
    ...
    var badge = $(e.target).hasClass("api-catalog-pill")
      ? $(e.target)
      : $(e.target).parents(".api-catalog-pill");
