...
ckan.module("multiselect", function($) {
  return {
    initialize: function() {
      let changes = false;
      ...
      $(document).click(function(e) {
        // Check if click was triggered on or within .multiselect element
        ...
        $(".multiselect.expanded").removeClass("expanded");
      });

      // Add dropdown toggle event to main button
      this.el
        .find(".multiselect-toggle")
        .on("click", (e) => {
      ...
      this.el[0]
        .querySelectorAll(`[id*=multiselect-dropdown-${this.options.name}]`)
